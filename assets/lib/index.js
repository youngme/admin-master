...
layui.extend({
    ...
    admin: "lib/admin",
    view: "lib/view",
    reqSetter:"lib/reqConfig",
    financeSetter:"lib/financeConfig"
}).define(["setter", "admin","reqSetter","financeSetter"],
    function(a) {
        var e = layui.setter,
            i = layui.element,
            n = layui.admin,
            t = n.tabsPage,
            d = layui.view
            dot = '<span class="layui-badge-dot layui-bg-blue" style="left: -6px;"></span>',
            l = function(a, d) {
