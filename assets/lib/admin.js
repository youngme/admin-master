                ...
                rollPage: function(e, i) {
                    ...
                    if ("left" === e) {
                        ...
                        function() {
                            var e, r = n.eq(i);
                            // console.log(r);
                            r.find(".layui-badge-dot").removeClass("layui-bg-gray").addClass("layui-bg-blue");
                            r.siblings("li").find(".layui-badge-dot").removeClass("layui-bg-blue").addClass("layui-bg-gray");
                            if (r[0]) {
